...
public class PostController {
    ...
    public ResponseEntity<GenericResponseDto> createPost(PostInfoDto postInfoDto, Authentication authentication) throws IOException, InterruptedException, PostNotValidException, FileUploadException, UserNotFoundException {
    ...
    public ResponseEntity<GenericResponseDto> deletePost(@PathVariable("postId") String postId, Authentication authentication) throws PostNotFoundException, OperationNotAllowedException, FileDeleteException, UserNotFoundException {
    ...
    public ResponseEntity<AggregatePostsDto> getPostsByUser(@PathVariable("userId") Integer userId, SearchParametersDto searchParameters, Authentication authentication) throws InterruptedException {
